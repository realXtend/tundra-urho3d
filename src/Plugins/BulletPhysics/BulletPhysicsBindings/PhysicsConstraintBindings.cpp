...
static duk_ret_t PhysicsConstraint_SetAttribute_String_Variant_AttributeChange__Type(duk_context* ctx)
{
...
static duk_ret_t PhysicsConstraint_GetAttribute_String(duk_context* ctx)
{
    PhysicsConstraint* thisObj = GetThisWeakObject<PhysicsConstraint>(ctx);
    String id = duk_require_string(ctx, 0);
...
static const duk_function_list_entry PhysicsConstraint_Functions[] = {
    ...
    ,{"SetAttribute", PhysicsConstraint_SetAttribute_String_Variant_AttributeChange__Type, DUK_VARARGS}
    ,{"GetAttribute", PhysicsConstraint_GetAttribute_String, 1}
